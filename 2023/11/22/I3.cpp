...
int main(){
    ...
    // cout << mx[1][16].sec << endl;
    // For(i, 0, 127) if(mx[1][i].fir > 10 - mn[i]) cout << i << endl;
    // cout << mx[0][1].fir << endl;
    // For(i, 0, 127) if(mx[1][i].fir > 10 - mn[i]) cout << "asd" << endl;
    pw[0] = 1;
    // cout << mn[127] << endl;
