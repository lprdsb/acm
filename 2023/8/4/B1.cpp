...
Data sol(int l, int r){
    if(l == r){
        ...
        res.F[6] = {a[l], 0};
        res.F[7] = {a[l], 0};
        res.F[8] = {Z{a[l] * a[l]} / 2, 0};
        res.F[9] = {a[l], 0};
        res.F[10] = {a[l], 0};
        res.F[11] = {Z{a[l] * a[l]} / 2, 0};
        res.F[12] = {Z{a[l] * a[l]} / 2, 0};
        res.F[13] = {a[l], 0};
        res.F[14] = {a[l], 0};
        res.F[15] = {a[l], 0};
        res.F[16] = {a[l], 0};
        res.F[17] = {Z{a[l] * a[l]} / 2, 0};
        res.F[18] = {Z{a[l] * a[l]} / 2, 0};
        res.F[19] = {Z{a[l] * a[l]} / 2, 0};
        res.F[20] = {Z{a[l] * a[l]} / 2, 0};
        res.F[21] = {Z{a[l] * a[l]} / 2, 0};
        res.F[22] = {Z{a[l] * a[l]} / 2, 0};
        res.F[23] = {Z{a[l] * a[l]} / 2, 0};
        res.F[24] = {Z{a[l] * a[l]} / 2, 0};
        res.F[25] = {Z{a[l] * a[l]} / 2, 0};
        res.F[26] = {a[l], 0};
        return res;
    }
    int mid = l + r >> 1;
...
int main(){
    Poly<998244353> F = {2};
    cout << F.size() << endl;
    // for(auto i : F) cout << i.x << " "; cout << endl;
}
